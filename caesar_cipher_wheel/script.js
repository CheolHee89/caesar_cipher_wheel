...
const translations = {
  ...
  ko: {
    ...
    instrContent: "1. 우측 상단의 언어 전환 버튼을 눌러 영어와 한글로 화면을 변경할 수 있습니다.<br/>2. 상단 코드 박스에는 카이사르 암호로 암호화된 단어가 표시됩니다.<br/>3. 외부 원판은 고정된 평문 알파벳(A~Z)이며, 내부 원판은 슬라이더에 따라 시프트된 암호 문자들이 표시됩니다.<br/>4. 슬라이더를 움직이면 내부 원판의 문자와 옆에 현재 시프트 암호 문자가 업데이트됩니다.<br/>5. '힌트 보기' 버튼을 누르면 실제 시프트 값이 표시 됩니다.<br/>6. 입력창에 원본 단어를 추측하여 입력하고 '단어 확인' 버튼을 누르면 정답 여부가 표시됩니다.<br/>7. '새 퍼즐' 버튼을 눌러 새로운 퍼즐을 생성할 수 있습니다."
  }
};
 ...
 * 2. DATA & UTILITIES
 ******************************************************/
const puzzleWords = ["DOG", "LOVE", "CAT", "FISH", "CODE", "KIDS", "LOCK", "MOON", "MATH", "STAR", "PLAN", "BOOK", "GAME", "PLAY", "HUG", "JUMP", "RUN", "DANCE", "SING", "HAPPY", "SMILE", "FUN", "ART", "MUSIC"];
...
function checkWord() {
  ...
  if (guess === originalWord) {
    ...
    successModal.innerHTML = '<div class="modal-content"><span class="close">&times;</span><h2>정답 입니다!</h2><p>선물을 받아가세요 :)</p></div>';
